...
This is the project, developed as a interviewing process for **Blinkist** requested at May 29, 2018.
Project's deadline is Jun 04, 2018.
...
- Configure the game by using the data provided at the following endpoint: [Blinkist API](https://private-75c7a5-blinkist.apiary-mock.com/connectFour/configuration). This configuration should be applied for each game.
